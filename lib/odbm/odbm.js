Q.Errors.declareError('RecordNotFound', 'No record matched key/query')
Q.Errors.declareError('OnlyOneRecordExpected', 'One record expected, but multiple returned')
Q.Errors.declareError('AtMostOneRecordExpected', 'Expected to find one record or no records at all')
