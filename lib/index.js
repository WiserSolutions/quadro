...
async function boot(opts) {
  ...
  Q.plugins = Plugin.loadList(opts.plugins || [])
  ...
  if (Q.app.isREPL) return runREPL()
  if (Q.app.isTask) return runTask()
}
...
async function runTests() {
  const testRunner = await container.getAsync('testRunner')
