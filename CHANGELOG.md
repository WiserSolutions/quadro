...
* **errors:** Rename InvalidOperation to InvalidOperationError and remove ([b532d30](https://github.com/WisePricer/quadro/commit/b532d30))
* **logging:** Change flush timeout from 60ms to 10sec ([211f961](https://github.com/WisePricer/quadro/commit/211f961))
